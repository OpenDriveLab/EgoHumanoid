...
class Pi0FAST(_model.BaseModel):
    ...
    def compute_loss(
        ...
        *,
        train: bool = False,
        action_mask: at.Bool[at.Array, "*b ah ad"] | None = None,  # Not used for FAST model (token-based loss)
    ) -> at.Float[at.Array, "*b ah"]:
        del action_mask  # FAST model uses token-based loss, action_mask not applicable
