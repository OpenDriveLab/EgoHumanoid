...
class DataExporterConfig(BaseConfig, ComposedCameraClientConfig):
    ...
    zed_camera_host: Optional[str] = "192.168.11.61"
    """ZED camera server host IP address. If None, ZED camera control is disabled."""

    zed_camera_port: int = 8888
    """ZED camera server port. Default is 8888."""
